<div align="center">
  ...
  **A focused Discord plugin for safely removing your own messages.**
  ...
  <p>
    ...
    ·
    <a href="https://github.com/RyanSSER/RyanPurge/releases/tag/v1.0.15">View release</a>
    ·
...
In Revenge versions that support plugin repositories, add the repository URL and install **RyanPurge 1.0.15**. If the + button asks for a direct plugin URL instead, use `https://ryansser.github.io/RyanPurge/index.js`. Use only the official RyanOS repository; unofficial mirrors, modified builds, and rebranded packages are not supported.
...
The current official release is **RyanPurge 1.0.15**. The exact package and release notes are available on the [GitHub release page](https://github.com/RyanSSER/RyanPurge/releases/tag/v1.0.15).
